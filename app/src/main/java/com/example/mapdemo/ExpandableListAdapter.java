...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
  ...
  public ExpandableListAdapter(Activity context, final List<String> bus_routes) {
    ...
    Log.i("Number of routes? ", "" + bus_routes.size());
  ...
  public View getChildView(final int groupPosition, final int childPosition,
    ...
    west.setOnClickListener(new CompoundButton.OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        MyLocationDemoActivity.mapHandler.showRoutes(cb.getText().toString(), 0, cb.isChecked());
    ...
    east.setOnClickListener(new CompoundButton.OnClickListener() {
      ...
      public void onClick(View view) {
        CheckBox cb = (CheckBox) view;
        MyLocationDemoActivity.mapHandler.showRoutes(cb.getText().toString(), 1, cb.isChecked());
